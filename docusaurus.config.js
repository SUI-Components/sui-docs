...
const config = {
  ...
  //     {
  //       // options here
  //       name: "design", // used by CLI, must be path safe
  //       sourceBaseUrl:
  //         "https://raw.githubusercontent.com/turolopezsanabria/DesignOps-Playbook/master", // the base url for the markdown (gets prepended to all of the documents when fetching)
  //       outDir: "docs/design-ops/", // the base directory to output to.
  //       documents: [
  //         "About-us.md",
  //         "Accessibility.md",
  //         "Advocate.md",
  ...
  //         "Boolean-traps.md",
  //         "Browser-support.md",
  //         // "Bugs.md", Expected corresponding JSX closing tag for <img>
  ...
  //       // options here
  //       id: "tools",
  //       name: "tools", // used by CLI, must be path safe
  //       sourceBaseUrl:
  ...
  //       outDir: "docs/sui-tools/", // the base directory to output to.
  //       documents: [
  ...
  //     {
  //       // options here
  //       name: "components", // used by CLI, must be path safe
  //       sourceBaseUrl:
  //         "https://raw.githubusercontent.com/SUI-Components/sui-components/master/components/", // the base url for the markdown (gets prepended to all of the documents when fetching)
  //       outDir: "docs/sui-components/", // the base directory to output to.
  //       documents: [
